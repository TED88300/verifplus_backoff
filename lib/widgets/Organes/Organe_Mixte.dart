...
class ArticleDataGridSource extends DataGridSource {
  ...
  void buildDataGridRows() {
    int i = 0;
    dataGridRows = DbTools.ListParc_Art_M.map<DataGridRow>((Parc_Art parc_Art) {
...
class Organe_MixteDialog extends StatefulWidget {
  @override
  State<Organe_MixteDialog> createState() => _Organe_MixteDialogState();
}

class _Organe_MixteDialogState extends State<Organe_MixteDialog> with SingleTickerProviderStateMixin {
  String Title = "";
  ...
  Widget build(BuildContext context) {
    ...
    print(" EQUIP build ${DbTools.ListParc_Art_M}");
