...
class ArticleDataGridSource extends DataGridSource {
  ...
  void buildDataGridRows() {
    int i = 0;
    dataGridRows = DbTools.ListParc_Art_S.map<DataGridRow>((Parc_Art parc_Art) {
...
class Organe_ServDialog extends StatefulWidget {
  @override
  State<Organe_ServDialog> createState() => _Organe_ServDialogState();
}

class _Organe_ServDialogState extends State<Organe_ServDialog> with SingleTickerProviderStateMixin {
  String Title = "";
  ...
  Widget build(BuildContext context) {
    ...
    print(" EQUIP build ${DbTools.ListParc_Art_S}");
