...
class NF074_Mixte_Produit_screen extends StatefulWidget {
  @override
  _NF074_Mixte_Produit_screenState createState() => _NF074_Mixte_Produit_screenState();
}

class _NF074_Mixte_Produit_screenState extends State<NF074_Mixte_Produit_screen> with TickerProviderStateMixin {
  int iboucle = 0;
...
//  List<EasyTableColumn<Param_Param>> wColumns = [];
  ...
  Future Filtre() async {
    ...
    DbTools.ListNF074_Mixte_Produitsearchresult.addAll(DbTools.ListNF074_Mixte_Produit);

    print("DbTools.ListNF074_Mixte_Produitsearchresult ${DbTools.ListNF074_Mixte_Produitsearchresult.length}");
    setState(() {});
  }
            ...
            child: Column(
              children: [
                Row(children: [
                  ...
                  iStrfExp
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          "Export Mixte_Produit sur serveur",
                  ...
                  Text(
                    iStrfExp ? "Export ${iboucle} / ${DbTools.ListNF074_Mixte_Produit.length}" : "Mixte_Produit ${DbTools.ListNF074_Mixte_Produit.length}",
                    style: gColors.bodySaisie_N_G,
                  ),
                  Container(
                    width: 12,
...
//**********************************
  ...
  void _onRowTap(BuildContext context, NF074_Mixte_Produit paramHab) {
    setState(() {
    });
  }
}
