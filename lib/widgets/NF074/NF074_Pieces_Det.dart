...
//  List<DaviColumn<Param_Param>> wColumns = [];
  ...
  Widget Param_Saisie_ParamGridWidget() {
    List<DaviColumn<NF074_Pieces_Det>> wColumns = [
      ...
      new DaviColumn(name: 'CodeArticle', grow: 2, stringValue: (row) => "${row.NF074_Pieces_Det_CodeArticle}"),
 ...
 //   print("NF074_Pieces_DetGridWidget");
    ...
    _model = DaviModel<NF074_Pieces_Det>(rows: DbTools.ListNF074_Pieces_Detsearchresult, columns: wColumns);
