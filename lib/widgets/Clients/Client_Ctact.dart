...
//      new EasyTableColumn(name: 'Code', width: 60, stringValue: (row) => "${row.Contact_Code}"),
      new EasyTableColumn(name: 'Adresse', grow: 15, stringValue: (row) => "${row.Contact_Type_Lib}"),
    ...
    return new EasyTableTheme(
        child: new EasyTable<Contact>(visibleRowsCount: 16, _model, onRowTap: (Contact) async {
